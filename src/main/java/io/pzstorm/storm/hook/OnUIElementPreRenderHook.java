...
public class OnUIElementPreRenderHook implements StormHook {
	...
	public void installHook(StormClassTransformer transformer) {
		...
		LabelNode callPrerender = AsmUtils.getFirstMatchingLabelNode(instructions, ImmutableList.of(
				...
				new MethodInsnNode(Opcodes.INVOKESTATIC, "zombie/ui/UIManager", "getDefaultThread",
						"()Lse/krka/kahlua/vm/KahluaThread;"
				),
				new VarInsnNode(Opcodes.ALOAD, 0),
				new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "zombie/ui/UIElement", "getTable",
						"()Lse/krka/kahlua/vm/KahluaTable;"
				),
				new LdcInsnNode("prerender"),
				new MethodInsnNode(Opcodes.INVOKEINTERFACE, "se/krka/kahlua/vm/KahluaTable", "rawget",
								"(Ljava/lang/Object;)Ljava/lang/Object;", true
				),
				new VarInsnNode(Opcodes.ALOAD, 0),
				new FieldInsnNode(Opcodes.GETFIELD, "zombie/ui/UIElement", "table",
						"Lse/krka/kahlua/vm/KahluaTable;"
				),
